...
from YangOmegaAttributeGenerator import YangOmegaAttributeGenerator

class YangOmegaAttributeGeneratorTest(unittest.TestCase):
    def test_attribute_generator(self):
        ...
        # Run the generator.
        features = yg.generate_features(entries, lookup_path="../lookup-data/")
