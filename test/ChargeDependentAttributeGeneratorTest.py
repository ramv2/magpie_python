...
import numpy as np
from ChargeDependentAttributeGenerator import ChargeDependentAttributeGenerator
from CompositionEntry import CompositionEntry


class ChargeDependentAttributeGeneratorTest(unittest.TestCase):
    def test_attribute_generator(self):
        ...
        features = cg.generate_features(entries, lookup_path="../lookup-data/")
